...
declare const QueryNFTInfoRequest: {
...
declare const QueryNFTInfoResponse: {
	...
	fromPartial<I extends {
		...
		metadata?: {
			...
			} & Record<Exclude<keyof I["metadata"]["masterEdition"], keyof MasterEdition>, never>;
		} & Record<Exclude<keyof I["metadata"], keyof Metadata>, never>;
	} & Record<Exclude<keyof I, keyof QueryNFTInfoResponse>, never>>(object: I): QueryNFTInfoResponse;
};
declare const QueryNFTsByOwnerRequest: {
...
declare const QueryNFTsByOwnerResponse: {
	...
	fromPartial<I extends {
		...
		metadata?: {
			...
			creators?: {
				...
				verified?: boolean;
				share?: number;
			} & Record<Exclude<keyof I["metadata"][number]["creators"][number], keyof Creator>, never>)[] & Record<Exclude<keyof I["metadata"][number]["creators"], keyof {
				address?: string;
				verified?: boolean;
				share?: number;
			}[]>, never>;
			...
			} & Record<Exclude<keyof I["metadata"][number]["masterEdition"], keyof MasterEdition>, never>;
...
declare const QueryMetadataRequest: {
...
declare const QueryMetadataResponse: {
...
declare const QueryCollectionRequest: {
...
declare const QueryCollectionResponse: {
...
export declare type BluzelleDelegatorUnbondingDelegationsResponse = {
	unbondingDelegations: BluzelleUnbondingDelegation[];
	pagination: PageResponse;
};
export declare type BluzelleUnbondingDelegation = {
	delegatorAddress: string;
	validatorAddress: string;
	entries: BluzelleUnbondingDelegationEntry[];
	totalBalance: number;
};
export declare type BluzelleUnbondingDelegationEntry = {
...
export declare const getNftInfo: (client: BluzelleClient, id: string) => Promise<{
	nft: {
		collId: any;
		seq: any;
		metadataId: any;
...
export declare const getCollectionInfo: (client: BluzelleClient, id: number) => Promise<{
	collection: {
		id: any;
		symbol: string;
		name: string;
...
export declare const getNftMetadata: (client: BluzelleClient, id: number) => Promise<{
	metadata: {
		id: any;
		masterEdition: {
			supply: any;
...
export declare const getNftByOwner: (client: BluzelleClient, owner: string) => Promise<{
	nfts: {
		collId: any;
		seq: any;
		metadataId: any;
